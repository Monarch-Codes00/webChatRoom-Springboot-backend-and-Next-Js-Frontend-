      ...
      <RoleGuard 
        ...
        fallback={
          <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-4">
            ...
            <h2 className="text-2xl font-bold text-foreground tracking-tight">ESG Access Restricted</h2>
            <p className="text-muted-foreground max-w-md">
              Sustainability metrics and ESG leaderboard data are reserved for administrative accounts and fleet managers.
            </p>
          </div>
        }
      >
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }} className="glass-card p-5 mt-6">
