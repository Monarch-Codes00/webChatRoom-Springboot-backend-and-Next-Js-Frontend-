      ...
      <RoleGuard 
        ...
        fallback={
          <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-4">
            ...
            <h2 className="text-2xl font-bold text-foreground tracking-tight">Compliance & Legal Access</h2>
            <p className="text-muted-foreground max-w-md">
              Regulatory compliance documents, vehicle permits, and driver certifications are restricted to administrative personnel.
            </p>
          </div>
        }
      >
