    ...
    CommandLineRunner initDatabase(
        ...
        return args -> {
            if (vehicleRepo.count() == 0) {
                ...
                // Seed Vehicles
                Vehicle v1 = new Vehicle(null, "VN-101", "CA-7842-XL", "Tesla Semi", "John Doe", 37.7749, -122.4194, 65.0, 78.5, 12500.0, "Feb 10, 2026", 4.2, "IN_TRANSIT");
                ...
                Vehicle v3 = new Vehicle(null, "VN-103", "NY-4423-CC", "Freightliner Cascadia", "Mike Ross", 40.7128, -74.0060, 0.0, 91.0, 4500.0, "Feb 05, 2026", 5.0, "MAINTENANCE");
                vehicleRepo.saveAll(List.of(v1, v2, v3));

                // Seed Shipments
                Shipment s1 = new Shipment(null, "SH-9001", "Global Corp", "Chris Obi", "San Francisco, CA", "New York, NY", "123 Tech Lane, NY", "2,400 kg", "IN_TRANSIT", 40.7589, -73.9851, LocalDateTime.now().plusHours(4), LocalDateTime.now(), v1);
                Shipment s2 = new Shipment(null, "SH-9002", "NextGen Logistics", "Sarah Connor", "Austin, TX", "Los Angeles, CA", "456 Cyber St, LA", "1,800 kg", "PENDING", 34.0522, -118.2437, LocalDateTime.now().plusDays(1), LocalDateTime.now(), v2);
