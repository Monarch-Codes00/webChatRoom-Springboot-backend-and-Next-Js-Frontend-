        ...
        fallback={
          <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-4">
            ...
            <p className="text-muted-foreground max-w-md">
              Executive analytics and AI demand forecasting are reserved for administrative accounts. 
              Please contact your system administrator for elevated privileges.
            </p>
          </div>
        }
      >
